...
class OurDataConfig:
    """
    Data root (consistent with this project); pairing and parsing are defined by
    ...
    # Affine: align segment mean/std of noisy to reference (remove global gain/bias); not pointwise noisy≈reference.
