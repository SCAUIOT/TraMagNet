## Gaussian noise paired sample

This dataset contains a paired signal sample for gaussian noise denoising. The pair consists of two files with the same sample name, `sample1.txt`, stored under different subdirectories according to the dataset layout:

```text
datasets/gaussian_noise/
├── reference_signal/
...
| Column 3 | Noisy signal value | Measured signal amplitude after Gaussian noise contamination |

An example row has the following structure:

```text
449    1610678462805    147.55097867
```
