## High-voltage cable noise paired sample

This dataset contains a paired signal sample for high-voltage cable noise denoising. The pair consists of two files with the same sample name, `sample1.txt`, stored under different subdirectories according to the dataset layout:

```text
datasets/high-voltage_noise/
├── reference_signal/
...
In this row, `449` is the sample index, `1610678462805` is the timestamp, and `753` is the noisy signal amplitude at that sampling point.
